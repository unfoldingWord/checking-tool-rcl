...
export const SelectedText = ({ children }) => (
  <Typography component={'strong'} sx={{ color: 'var(--accent-color)' }}>{children}</Typography>
)
...
const InstructionsAreaTextSelection = ({
  ...
  if (windowSelectionHelpers.shouldRenderBreak(selections, verseText)) {
    return (
      <div
        style={{ color: 'var(--accent-color)', direction: languageDirection }}
      >
        <Typography component='span' className={fontClass}>
